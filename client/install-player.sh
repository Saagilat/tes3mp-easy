...
download "client/layer2/player/interactive-install-client"  "$UPDATE_DIR/layer2/player/interactive-install-client"
download "client/layer2/player/interactive-run-client"       "$UPDATE_DIR/layer2/player/interactive-run-client"
download "client/layer2/player/interactive-run-openmw-cs"    "$UPDATE_DIR/layer2/player/interactive-run-openmw-cs"
download "client/layer2/player/interactive-install-mods"     "$UPDATE_DIR/layer2/player/interactive-install-mods"
...
download "client/layer2/player/interactive-show-backups-mods"    "$UPDATE_DIR/layer2/player/interactive-show-backups-mods"
download "client/layer2/player/interactive-show-backups-players" "$UPDATE_DIR/layer2/player/interactive-show-backups-players"
download "client/layer2/player/interactive-show-backups-world"   "$UPDATE_DIR/layer2/player/interactive-show-backups-world"
download "client/layer2/player/interactive-edit-config"      "$UPDATE_DIR/layer2/player/interactive-edit-config"
download "client/layer2/player/interactive-edit-client-cfg"  "$UPDATE_DIR/layer2/player/interactive-edit-client-cfg"
