...
download "client/layer1/player/show-backups-state"       "$UPDATE_DIR/layer1/player/show-backups-state"
download "client/layer1/player/download-backup-mods"     "$UPDATE_DIR/layer1/player/download-backup-mods"
download "client/layer1/player/download-backup-state"    "$UPDATE_DIR/layer1/player/download-backup-state"
...
download "client/layer2/admin/interactive-deploy-state"        "$UPDATE_DIR/layer2/admin/interactive-deploy-state"
download "client/layer2/admin/interactive-download-mods"       "$UPDATE_DIR/layer2/admin/interactive-download-mods"
download "client/layer2/admin/interactive-download-state"      "$UPDATE_DIR/layer2/admin/interactive-download-state"
...
download "client/layer2/player/interactive-download-state"   "$UPDATE_DIR/layer2/player/interactive-download-state"
...
download "server/scripts/deploy_state.sh"     "$UPDATE_DIR/server/scripts/deploy_state.sh"
